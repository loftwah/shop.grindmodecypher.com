...
<div class="wcccf_option_box_container"> 
	...
	<select name="wcccf_field_data[<?php echo $field_id; ?>][conditional_group_item][<?php echo $conditional_item_id; ?>][operator]" >
		...
		<option value="greater_or_equal" <?php if(isset($coditional_item_data['operator'])) selected( $coditional_item_data['operator'], 'greater_or_equal' ); ?>><?php _e('Greater or equal','woocommerce-conditional-checkout-fields');?></option>
		<option value="lesser_or_equal" <?php if(isset($coditional_item_data['operator'])) selected( $coditional_item_data['operator'], 'lesser_or_equal' ); ?>><?php _e('Lesser or equal','woocommerce-conditional-checkout-fields');?></option>
	</select>
</div> 