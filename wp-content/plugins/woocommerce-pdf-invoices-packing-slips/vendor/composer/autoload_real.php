...
class ComposerAutoloaderInita44f2cb79329ce99e54227132018137a
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInita44f2cb79329ce99e54227132018137a::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequirea44f2cb79329ce99e54227132018137a($fileIdentifier, $file);
        }
